...
public class TransactionGroup {
    private static final Comparator<Map.Entry<String, Double>> valueOrder = Map.Entry.comparingByValue();
    private static final Comparator<Map.Entry<String, Double>> reversedValueOrder = valueOrder.reversed();
